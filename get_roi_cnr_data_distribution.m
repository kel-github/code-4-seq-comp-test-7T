...
%        data_dir = '/scratch/qbi/uqkgarn1/STRIWP1/derivatives/glmTDFAST/';
        ims = '/scratch/qbi/uqkgarn1/STRIWP1/derivatives/glmTDFAST_HANDS/sub-%s/TR%s/THRSH/spmT_*thresh.nii.gz';
end
...
if isempty(save_name)
    save_name = '/scratch/qbi/uqkgarn1/STRIWP1/derivatives/glmTDFAST_HANDS/HANDS_activationC_tCNR_stat_vox_agg.csv';
end
