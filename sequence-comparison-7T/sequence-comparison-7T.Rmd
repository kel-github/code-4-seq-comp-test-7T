...
```{r, out.width="2000px", fig.align='center', fig.cap="CNR values plotted for subjects 2 (left column) and 5 (right column). Figures show a random cross-section for each participant to give an idea of CNR values across ROIs"}
knitr::include_graphics("../CNR/subs-02-05-summary.pdf")
```
