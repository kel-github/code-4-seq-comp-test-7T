...
```{r, out.width="1000px", fig.align='center', fig.cap="CNR values plotted for subjects 2 (left column) and 5 (right column). Figures show a random cross-section for each participant to give an idea of CNR values across ROIs"}
